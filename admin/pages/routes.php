...
if (resolve('/admin/pages')){
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST'){
        $pages_create();
        return header('location: /SchoolOfNet/aulaPHP/P/public/index.php/admin/pages');
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST'){
        $pages_edit($params[1]);
        return header('location: /SchoolOfNet/aulaPHP/P/public/index.php/admin/pages/' . $params[1]);
    }
    $page =$pages_one($params[1]);
