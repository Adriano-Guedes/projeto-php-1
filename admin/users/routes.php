...
if (resolve('/admin/users')) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $users_create();
        return header('location: /SchoolOfNet/aulaPHP/P/public/index.php/admin/users');
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $users_edit($params[1]);
        return header('location: /SchoolOfNet/aulaPHP/P/public/index.php/admin/users/' . $params[1]);
    }
    $user = $users_view($params[1]);
